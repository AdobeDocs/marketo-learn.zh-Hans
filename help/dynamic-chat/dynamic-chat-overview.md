...
* 概述
   ...
   * **[15分钟后上线](go-live-in-15-minutes.md)**
     *分步指南帮助您使用[!UICONTROL Dynamic Chat]在15分钟内完成第一个对话！*
* 设置
...
* 自动聊天
   ...
   * **[在对话中嵌入PDF](document-cloud-integration.md)**
     *在您在[!UICONTROL Dynamic Chat]中设计的个性化对话中共享PDF文档。*
