---
user-guide-title: 教程 — 有关审核继承的Marketo Engage实例的提示和技巧
user-guide-description: 有关审核继承的Marketo Engage实例的提示和技巧
breadcrumb-title: 教程 — 有关审核继承的Marketo Engage实例的提示和技巧
...
# 教程 — 有关审核继承的Marketo Engage实例的提示和技巧 {#auditing-an-inherited-instance}

+ [教程 — 概述](/help/tutorial-inherited-instance/overview.md)
...
+ [项目启动前质量Assurance流程](/help/tutorial-inherited-instance/essential-program-pre-launch-qa.md)
+ [Marketo Engage 教程](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/overview.html?lang=zh-Hans)
