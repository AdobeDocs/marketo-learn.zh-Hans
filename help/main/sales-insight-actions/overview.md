---
title: Sales Insight Actions教程
description: 使用[!UICONTROL Sales Insight Actions]通过单个工作流中的营销支持智能和参与工具加快发现潜在客户的工作。
...
使用[!UICONTROL Sales Insight Actions]通过单个工作流中的营销支持智能和参与工具加快发现潜在客户的工作。
...
<tr>
<td>
<a href="/help/main/sales-insight-actions/sales-insight-actions-overview.md"><img alt="Sales的缩略图Insight操作概述" src="assets/sales-insight-actions-feature-overview-videothumb.png" /></a>
<div><a href="/help/main/sales-insight-actions/sales-insight-actions-overview.md"><strong>销售Insight操作概述</strong></a></div>
</td>
<td>
<a href="/help/main/sales-insight-actions/accessing-your-sales-insight-actions-instance.md"><img alt="用于访问Sales Insight Actions实例的缩略图" src="assets/accessing-your-sales-insight-actions-instance-videothumb.png" /></a>
<div><a href="/help/main/sales-insight-actions/accessing-your-sales-insight-actions-instance.md"><strong>访问您的Sales Insight Actions实例</strong></a></div>
</td>
<td>
<a href="/help/main/sales-insight-actions/configure-sales-activity-logging-to-salesforce.md"><img alt="用于将Sales Activity Logging配置到的缩略图图像 [!DNL Salesforce]" src="assets/configure-sales-activity-logging-to-salesforce-videothumb.png" /></a>
<div><a href="/help/main/sales-insight-actions/configure-sales-activity-logging-to-salesforce.md"><strong>将销售活动日志记录配置到[!DNL Salesforce]</strong></a></div>
</td>
</tr>
</table>
